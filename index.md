    ...
    <div class="process-list">
      ...
      <div class="process-item fade-up">
        ...
        <div class="process-body">
          ...
          <p class="process-text">If a technology doesn't directly serve a human learning outcome, it doesn't belong in our design.</p>
        </div>
      </div>
      <div class="process-item fade-up">
        ...
        <div class="process-body">
          ...
          <p class="process-text">Education is always evolving, and so are we. Constant reflection and reinvention, not fixed solutions.</p>
        </div>
      </div>
    </div>
  </div>
...
<section class="home-section hs-mid">
  <div class="home-inner">
    ...
    {% include youtube.html id="e-MBxPDtwCg" %}
    <p class="testimonial-caption">Faculty feedback from CBPAI — conducted on the ViBe platform.</p>
  </div>
</section>
