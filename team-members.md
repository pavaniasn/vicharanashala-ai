...
<div class="team-section">
  ...
  <div class="team-grid">
    ...
    <div class="team-card">
      <div class="team-avatar" style="background:#1a1a1a; color:#f9f9f7;">SI</div>
...
<div class="team-ops">
  <h2 class="team-section-h">Operations &amp; Support</h2>
  <p class="team-ops-p">Behind every program and product is a layer of coordination that keeps things running. Vicharanashala is supported by dedicated admin and operations staff, NPTEL pre-doc fellows, and a rotating cohort of offline interns — each contributing to the lab's day-to-day functioning and outreach.</p>
  <p class="team-ops-p">Multiple positions are actively open under UGC-MMTTP. <a href="{{ site.baseurl }}/openings/">See openings →</a></p>
</div>
